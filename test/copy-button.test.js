...
async function fillCopyFields(page) {
  await page.evaluate(function () {
    document.querySelector('#titleInput').value = 'Fallback Title';
    document.querySelector('#bodyInput').value = 'Fallback body';
    document.querySelector('#tagsInput').value = '#ColorWalk #Fallback';
  });
}
